...
int main(){
	...
	reglasGramatica["2S"] = "bA";
	reglasGramatica["3A"] = "a";
	reglasGramatica["4A"] = "aS";
	reglasGramatica["5A"] = "bAA";
	reglasGramatica["7B"] = "b";
	reglasGramatica["8B"] = "bS";
	reglasGramatica["6B"] = "aBB";
	reglasGramatica["L"] = "aB";    
